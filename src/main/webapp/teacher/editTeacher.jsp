...
<form class="layui-form" action="">
    ...
    <input type="hidden" name="teaPassword" id="teaPassword" value="${CurrentLoginUserInfo.teaPassword}" />
    <fieldset class="layui-elem-field">
  <legend>基本信息</legend>
  		<div class="layui-form-item" style="margin-bottom:3px;">
	        <label class="layui-form-label" style="font-size:12px;line-height:10px;">账号</label>
	        <div class="layui-input-inline">
	            <input type="text" name="loginId" id="loginId"  value="${CurrentLoginUserInfo.loginId}" lay-verify="required" placeholder="必填项" autocomplete="off" 
	        ...
	        <label class="layui-form-label" style="font-size:12px;line-height:10px;">姓名</label>
	         <div class="layui-input-inline">
	            <input type="text" name="teaName" id="teaName"  value="${CurrentLoginUserInfo.teaName}" lay-verify="required" placeholder="必填项" autocomplete="off"
	                   class="layui-input layui-form-danger" style="height:26px;font-size:12px;">
	        </div>
        </div>
     </fieldset>
