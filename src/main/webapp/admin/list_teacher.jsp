	         ...
	         <div class="layui-field-box">
		        ...
		        <div class="my-btn-box" style="margin-bottom:-10px;">
		            <div class="fl">
		                ...
		                <!-- <a class="layui-btn layui-btn-sm" id="btn-grant-batch"><i class="layui-icon"></i>批量授权</a> -->
	    ...
	    layui.use(['table', 'layer'], function () {
	        ...
	        table.render({
			    ...
			    ,cols: [[ 
			      ...
			      ,{field: 'teaName', title: '<span style="color:#000;font-weight:bold;">姓名</span>',align: 'center'}
			      ...
			      ,{field: '', title: '<span style="color:#000;font-weight:bold;">操作</span>',align: 'center',toolbar: '#toolbar',width:260}
			    ]]
	        	,url:'${pageContext.request.contextPath}/teacher/list'
	        	,id: 'teacherListTable'
	        	,where: {
	        ...
	        //批量添加 
	      	$("#btn-add-batch").click(function(){
	      		layer.open({
	      		  ...
	      		  ,maxmin: false //开启最大化最小化按钮
	      		  ,anim: 5 //0-6的动画形式，-1不开启
	      		  ,content: 'uploadTeacherExcel.jsp'
	      	   });
	      	});
	      	
	        //批量授权
	        $("#btn-grant-batch").click(function(){
	        	...
	        	if(data.length>0){
			    	...
			    	layer.open({
			    		  ...
			    		  ,maxmin: false //开启最大化最小化按钮
			    		  ,anim: 5 //0-6的动画形式，-1不开启
			    		  ,content: 'grantCourse.jsp?idStr='+idStr
				    	 });
			...
			//页面刷新
	      	...
	      	//toolBar操作列监听
	      	 table.on('tool(tableFilter)', function(obj){
	      	    ...
	      	    if(obj.event === 'del'){
	      	      ...
	      	      layer.open({
	        		  ...
	        		  ,maxmin: false //开启最大化最小化按钮
	        		  ,anim: 5 //0-6的动画形式，-1不开启
	        		  ,content: 'editTeacher.jsp?id='+data.id
	        	   });
	      	  ...
	      	  if(obj.event === 'editPassword'){
	    		  ...
	    		  ,maxmin: false //开启最大化最小化按钮
	    		  ,anim: 5 //0-6的动画形式，-1不开启
	    		  ,content: 'editTeacherPassword.jsp?id='+data.id
		    	 });
	      	 ...
	      	 if(obj.event === 'grant'){
	    		  ...
	    		  ,maxmin: false //开启最大化最小化按钮
	    		  ,anim: 5 //0-6的动画形式，-1不开启
	    		  ,content: 'grantCourse.jsp?idStr='+data.id
		    	 });
...
<script type="text/html" id="toolbar">
	<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="editPassword" style="font-size:10px;"><i class="layui-icon">&#xe857;</i>改密</a>
    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="grant" style="font-size:10px;"><i class="layui-icon">&#xe857;</i>授权</a>
