	    ...
	    layui.use(['table', 'layer'], function () {
	        ...
	        table.render({
			    ...
			    ,cols: [[ 
			      ...
			      ,{field: 'stuName', title: '<span style="color:#000;font-weight:bold;">姓名</span>',align: 'center'}
	    	...
	    	//批量添加 
	      	$("#btn-add-batch").click(function(){
	      		layer.open({
	      		  ...
	      		  ,maxmin: false //开启最大化最小化按钮
	      		  ,anim: 5 //0-6的动画形式，-1不开启
	      		  ,content: 'uploadStudentExcel.jsp'
	      	   });
	      	});
	      	//批量删除
			    ...
			    if(data.length>0){
			    	...
			    	layer.confirm('确认删除 '+data.length+' 条用户信息？', {
		      	    	  ...
		      	    	  btn: ['确认','取消'] //按钮
		      	    		...
		      	    		$.ajax({
		        	  			method: "post",
		        	  			url:"${pageContext.request.contextPath}/student/deleteBatch",
		        	  			data:{"idStr":idStr},
	      	 ...
	      	 table.on('tool(tableFilter)', function(obj){
	      	    ...
	      	    if(obj.event === 'del'){
	      	      ...
	      	      layer.open({
	        		  ...
	        		  ,maxmin: false //开启最大化最小化按钮
	        		  ,anim: 5 //0-6的动画形式，-1不开启
	        		  ,content: 'editStudent.jsp?id='+data.id
	        	   });
	      	  ...
	      	  if(obj.event === 'show'){
	    		  ...
	    		  ,maxmin: false //开启最大化最小化按钮
	    		  ,anim: 5 //0-6的动画形式，-1不开启
	    		  ,content: 'eidtStudentPassword.jsp?id='+data.id
		    	 });
