		        ...
		        <div class="my-btn-box" style="margin-bottom:-10px;">
		            ...
		            <div class="fr" >
		                ...
		                <div class="layui-input-inline">
		                    <input type="text" autocomplete="off" id="keywords" name="keywords" placeholder="课程名" class="layui-input " style="height:26px;font-size:12px;"/>
		                </div> 
	    ...
	    layui.use(['table', 'layer'], function () {
	        ...
	        table.render({
			    ...
			    ,cols: [[ 
			       ...
			       {type: 'checkbox'}
				  ,{field: 'id', title: '<span style="color:#000;font-weight:bold;">课程ID</span>',align: 'center'}
			      ,{field: 'courseName', title: '<span style="color:#000;font-weight:bold;">课程名</span>',align: 'center'}
			      ,{field: 'status', title: '<span style="color:#000;font-weight:bold;">状态</span>',align: 'center'}
			    ...
			    if(data.length>0){
			    	...
			    	layer.confirm('确认删除 '+data.length+' 条用户信息？', {
		      	    	  ...
		      	    	  btn: ['确认','取消'] //按钮
		      	    		...
		      	    		$.ajax({
		        	  			method: "post",
		        	  			url:"${pageContext.request.contextPath}/course/deleteBatch",
		        	  			data:{"idStr":idStr},
	      	 ...
	      	 table.on('tool(tableFilter)', function(obj){
	      	    ...
	      	    if(obj.event === 'del'){
	      	      ...
	      	      layer.open({
	        		  ...
	        		  ,maxmin: false //开启最大化最小化按钮
	        		  ,anim: 5 //0-6的动画形式，-1不开启
	        		  ,content: 'editCourse.jsp?id='+data.id
	        	   });
