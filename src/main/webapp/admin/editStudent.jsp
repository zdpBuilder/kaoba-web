...
<form class="layui-form" action="">
    ...
    <input type="hidden" name=stuPassword id="stuPassword" value="<%=id%>"/>
  ...
  <legend>基本信息</legend>
  		<div class="layui-form-item" style="margin-bottom:3px;">
	        ...
	        <label class="layui-form-label" style="font-size:12px;line-height:10px;">姓名</label>
	         <div class="layui-input-inline">
	            <input type="text" name="stuName" id="stuName" lay-verify="required" placeholder="必填项" autocomplete="off"
	                   class="layui-input layui-form-danger" style="height:26px;font-size:12px;">
	        </div>
        </div>
     </fieldset>
      ...
      $.ajax({
			...
			success:function(result){
				...
				if(result){
					...
					$("#stuPassword").val(result.stuPassword);
